...
export const useUserStore = create<
  ...
  [["zustand/persist", PersistOptions<UserState>]]
>(
  persist<UserState & UserActions, [], [], PersistOptions<UserState>>(
    (set, get) => ({
      ...
      logout: () => {
        logout().then(() => {
          document.cookie =
            "MUSIC_U=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/;domain=.music.163.com";
          document.cookie =
            "NMTID=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/;domain=.music.163.com";
          get().notLoggedIn();
        });
      },
