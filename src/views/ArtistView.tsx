  ...
  return (
    <Box mt={4}>
      ...
      {albumLoading ? (
        ...
        <Grid container spacing={3}>
          {albums.map((album) => (
            <Grid key={album.id} component={"div"}>
              <Box>
                <Box
                  sx={(theme) => ({
                    width: "15rem",
...
export function ArtistInfo({
  ...
  artistDetail: ArtistData | undefined;
  loading: boolean;
}) {
    ...
    >
      ...
      >
        ...
        <Typography variant="subtitle2" color="textSecondary">
          {artistDetail.artist.musicSize} {t("song-count")} ·{" "}
          {artistDetail.artist.albumSize} {t("album-count")} ·{" "}
          {artistDetail.artist.mvSize} {t("mv-count")}
        </Typography>
        <Typography
          variant="body2"
